...
function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-80px)] overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-white">
          ...
          <div className="w-full max-w-2xl space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-xl text-lg leading-8 text-slate-600">
                Discover concerts, hackathons, workshops, festivals,
                networking events, and unforgettable experiences happening
                around you. Reserve your seat in just a few clicks.
              </p>
            </div>
